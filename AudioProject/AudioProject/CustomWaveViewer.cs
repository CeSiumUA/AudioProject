...
namespace AudioProject
{
    ...
    public class CustomWaveViewer : System.Windows.Forms.UserControl
    {
        ...
        public void Zoom(int leftSample, int rightSapmle)
        {
            startPosition = leftSample * bytesPerSample;
            samplesPerPixel = (rightSapmle - leftSample) / this.Width;
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
            if (mouseDrag && e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                int rightSample = (int)(StartPosition + samplesPerPixel * Math.Max(startPos.X, mousePos.X));
